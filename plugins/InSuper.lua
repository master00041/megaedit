...
local function check_member_super(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'This Supergroup Has been Added to my GroupList!! \n Added by : @'..msg.from.username..' \n your id: |'..msg.from.id..'|'
...
local function check_member_superrem(cb_extra, success, result)
  ...
  for k,v in pairs(result) do
    ...
    if member_id ~= our_id then
      ...
      save_data(_config.moderation.data, data)
	  local text = 'This Supergroup Has been Removed from my GroupList!! \n Removed by : @'..msg.from.username..' \n your id : |'..msg.from.id..'|'
      return reply_msg(msg.id, text, ok_cb, false)
    end
  end
end
...
local function lock_group_links(msg, data, target)
  ...
  if group_link_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"#Link posting has been #Locked!! \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_links(msg, data, target)
  ...
  if group_link_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Link posting has been #unlocked \n #Unlocked by : @"..msg.from.username.." \n Your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"#Supergroup Spam has been Locked!! \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_spam(msg, data, target)
  ...
  if group_spam_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id," #SuperGroup #spam has been #unlocked!! \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Spamming has been #locked \n Locked by : @"..msg.from.username.." \n  Your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_flood(msg, data, target)
  ...
  if group_flood_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Spamming has been #unlocked \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Arabic/Persian has been #locked \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_arabic(msg, data, target)
  ...
  if group_arabic_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Arabic/Persian has been #unlocked \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_tag(msg, data, target)
  ...
  if group_tag_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Tag has been #locked \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_tag(msg, data, target)
  ...
  if group_tag_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> Tag has been #unlocked \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_webpage(msg, data, target)
  ...
  if group_webpage_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #WebLink posting has been #locked \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_webpage(msg, data, target)
  ...
  if group_webpage_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #WebLink posting has been #unlocked \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Forward Msg has been #locked \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_fwd(msg, data, target)
  ...
  if group_fwd_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Forward Msg has been #unlocked \n Unlocked by : @"..msg.from.username.." \n your id |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_badw(msg, data, target)
  ...
  if group_badw_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Badwords Has been #locked!! \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_badw(msg, data, target)
  ...
  if group_badw_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Badwords has been #unlocked!! \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Emoji Has been #locked!! \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_emoji(msg, data, target)
  ...
  if group_emoji_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Emoji has been #unlocked \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_eng(msg, data, target)
  ...
  if group_eng_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #English Has been #locked!! \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_eng(msg, data, target)
  ...
  if group_eng_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #English has been #unlocked!! \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
local function unlock_group_membermod(msg, data, target)
  ...
  if group_member_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> SuperGroup #members has been #unlocked!! \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #RTL has been #Locked \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_rtl(msg, data, target)
  ...
  if group_rtl_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #RTL has been #unlocked!! \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_tgservice(msg, data, target)
  ...
  if group_tgservice_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #TGservice has been #unlocked \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function lock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Sticker posting has been #locked \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_sticker(msg, data, target)
  ...
  if group_sticker_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Sticker posting has been #unlocked \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."| ", ok_cb, false)
  end
end
...
local function lock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Contact posting has been #locked!! \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function unlock_group_contacts(msg, data, target)
  ...
  if group_contacts_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Contact posting has been #unlocked!! \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function enable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'yes' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Settings will be #strictly_enforced!!  \n Locked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function disable_strict_rules(msg, data, target)
  ...
  if group_strict_lock == 'no' then
    ...
    save_data(_config.moderation.data, data)
    return reply_msg(msg.id,"> #Settings will #not be strictly enforced \n Unlocked by : @"..msg.from.username.." \n your id : |"..msg.from.id.."|", ok_cb, false)
  end
end
...
local function set_rulesmod(msg, data, target)
  ...
  save_data(_config.moderation.data, data)
  return reply_msg(msg.id,"*SuperGroup rules set \n Setted by : @"..msg.from.username.."", ok_cb, false)
end
